...
# 作り方
いくつかバージョンがあります。　造形時間は造形スピード60mm/s,積層ピッチ0.2mmの場合。参考単価は1kg3000円のフィラメントを使った場合。比較対象として[PRUSA](https://www.prusaprinters.org/prints/25857-prusa-protective-face-shield-rc2)のFacesheildは造形時間203分、参考単価203円になります。
